  ...
  const slides = [
    {
      ...
      text: `In healthcare, every second counts. Emergency preparedness means being ready for anything — from power outages to natural disasters. You are responsible for protecting yourself and your client during emergencies.`,
      lottie:
        "https://lottie.host/embed/99306861-5161-464d-86bd-b9287044e67f/s7oyFBjOsE.lottie",
...
• Follow the client’s emergency plan if available.`,
      lottie:
        "https://lottie.host/embed/056b6c67-4fe6-4646-8ed3-5f634693e2ba/9rZoFjXcV9.lottie",
...
• Have flashlights, water, and emergency numbers available.`,
      lottie:
        "https://lottie.host/embed/52b9c4d4-a988-4876-8e4c-403f37238663/wwEK3m5SQB.lottie",
...
• Call 911 if evacuation is necessary.`,
      lottie:
        "https://lottie.host/embed/2ba05b17-651b-486b-9e0e-c06fceea17c6/2Wb0ON7igw.lottie",
...
• Call for help immediately if a client is confused or fainting.`,
      lottie:
        "https://lottie.host/embed/524bf9a4-87a6-470b-b60b-259081e2419d/6DpEiRHsn1.lottie",
...
• Report unsafe heating conditions immediately.`,
      lottie:
        "https://lottie.host/embed/3bff2da1-3246-40d0-b054-84d1b2a07e7a/jaKL6d6FdI.lottie",
...
• Leave the home immediately if CO alarms sound and call 911.`,
      lottie:
        "https://lottie.host/embed/a8dd206d-2d07-4b4d-94f5-0ed7762c52f7/FzndQLMMCS.lottie",
...
• Seek medical evaluation as per company protocol.`,
      lottie:
        "https://lottie.host/embed/7ed14a40-b6bb-4f2b-9bc2-71905e31783d/8uPDxWAPUo.lottie",
...
• Stay with the client until emergency services arrive.`,
      lottie:
        "https://lottie.host/embed/9f050098-3bbb-446c-abc4-e6dab6919f71/tkXO1JfvY8.lottie",
...
• Report and document the incident.`,
      lottie:
        "https://lottie.host/embed/6c98299f-3db7-472d-905a-53cb10089a7b/T9PYLive5n.lottie",
...
• Provide accurate details for safety improvements.`,
      lottie:
        "https://lottie.host/embed/c5008abf-7ec9-4037-908f-4f8ffbe0cf14/MVqXskBODL.lottie",
...
• Communication and documentation are key.`,
      lottie:
        "https://lottie.host/embed/7d364752-a889-4f47-bf62-bf2874f3a5f3/ducMf8urt6.lottie",
    },
    {
      key: "ack",
